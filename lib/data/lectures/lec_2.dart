...
List<Widget> lec2Data = [
  ...
  buildExpansionTile(
    ...
    imagePath: "${ImageFolderPath.lec1}/img3.png",
  ),
  buildExpansionTile(
    index: '4',
  ...
  buildExpansionTile(
    ...
    imagePath: "${ImageFolderPath.lec1}/img6.png",
  ),
  buildExpansionTile(
    index: '7',
    ...
    imagePath: "${ImageFolderPath.lec1}/img7.png",
  ),
  buildExpansionTile(
    index: '8',
    ...
    imagePath: "${ImageFolderPath.lec1}/img8.png",
  ),
  buildExpansionTile(
    index: '9',
    ...
    imagePath: "${ImageFolderPath.lec1}/img9.png",
  ),
  buildExpansionTile(
    index: '10',
    ...
    imagePath: "${ImageFolderPath.lec1}/img10.png",
  ),
  buildExpansionTile(
    index: '11',
    ...
    imagePath: "${ImageFolderPath.lec1}/img11.png",
  ),
  buildExpansionTile(
    index: '12',
    ...
    imagePath: "${ImageFolderPath.lec1}/img12.png",
  ),
  buildExpansionTile(
    index: '13',
    ...
    imagePath: "${ImageFolderPath.lec1}/img13.png",
  ),
  buildExpansionTile(
    index: '14',
    ...
    imagePath: "${ImageFolderPath.lec1}/img14.png",
  ),
  buildExpansionTile(
    index: '15',
